...
const UIController = (function () {
  ...
  return {
    ...
    showTotal: function (total) {
      document.querySelector(Selectors.totalCAD).textContent = total;
      document.querySelector(Selectors.totalUSD).textContent = total * 1.3;
    },
...
const App = (function (ProductCtrl, UICtrl, StorageCtrl) {
  ...
  const productAddSubmit = function (e) {
    ...
    console.log(productName, productPrice, StorageController);
